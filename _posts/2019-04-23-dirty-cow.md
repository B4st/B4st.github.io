...
tags:
  - Linux
---
![Dirty Cow]({{ site.url }}{{ site.baseurl }}/assets/images/dirtyCow/dirty-COW.png)
# CVE-2016-5195
...
This is just a quick overview of the info available at the [NVD site](https://nvd.nist.gov/vuln/detail/CVE-2016-5195) about this vulnerability.
...
![COW]( {{ site.url }}{{ site.baseurl }}/assets/images/dirtyCow/COW.jpg "COW")
...
But, if these two threads are performed very quickly, the operations occurring multiple times a second, then you create a race. The two threads need to keep up with each other in order to remain interwoven. So if you do this over and over again very quickly, you can create this edge case where the timing doesn't work out and this can happen.
...
There are multiple proof of concepts available [here](https://github.com/dirtycow/dirtycow.github.io/wiki/PoCs). The code used in the demonstration is from the pokemon.c exploit available [here](https://github.com/dirtycow/dirtycow.github.io/blob/master/pokemon.c)
...
## References
[1] https://bugzilla.redhat.com/show_bug.cgi?id=1384344#

[2] https://www.zdnet.com/article/the-dirty-cow-linux-security-bug-moos/

[3] https://nvd.nist.gov/vuln/detail/CVE-2016-5195#vulnCurrentDescriptionTitle
...
[7] https://www.theregister.co.uk/2016/10/21/linux_privilege_escalation_hole/

[8] https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=19be0eaffa3ac7d8eb6784ad9bdbc7d67ed8e619
